...
error_reporting(0);
    ...
    $sql = "insert into signup (store, species, size, price, pickpup_name, cake_address, cake_number, phone) values ('$store', '$species', '$size', '$price', '$pickpup_name', '$cake_address', '$cake_number', '$phone')";
